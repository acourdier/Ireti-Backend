            ...
            <div class="row justify-content-center align-items-center py-5">
                <div class="col-12">
                    ...
                    <p class=" text-center text-center mt-3 fs-5" data-aos="fade-up" data-aos-delay="500">As a liquidity in both Commodity and Forex markets, Ireti
                        ...
                        commitments to enhance to transparency and reliability contributes to a more stable environment,
        ...
        <div class="mycontainer py-5">
            <div class="row justify-content-center align-items-center py-5">
                ...
                <div class="col-md-6 mt-5 mt-md-0 py-lg-3 ps-md-4" data-aos="fade-right" data-aos-delay="300">
                    ...
                    <p class="fs-5">In the realm of commodities, Ireti Capital stands as a trusted source of liquidity. Whether it's
            ...
            <div class="row justify-content-center flex-column-reverse flex-md-row align-items-center py-5">
                <div class="col-md-6 py-lg-3 mt-5 mt-md-0 pe-md-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="fs-5">In the Forex market, where constant fluctuations present both opportunities and challenges, Ireti
            ...
            <div class="row justify-content-center align-items-center py-5">
                ...
                <div class="col-md-6 py-lg-3 mt-5 mt-md-0  ps-md-4" data-aos="fade-down" data-aos-delay="300">
                    <h2 class="font-semi fs-1 green-text  ">Tailored Solutions for
                        diverse needs</h2>
                    <p class="fs-5">Recognizing the diverse needs of our clients, we offer tailored liquidity solutions accessible
