        ...
        <div class="mycontainer py-5">
            <div class="row justify-content-center align-items-center py-5">
                <div class="col-10 col-sm-8 col-md-6 py-lg-3" data-aos="fade-down" data-aos-delay="500">
                    <img src="{{asset('img/crane.svg')}}" alt="crane" class="w-100">
                </div>
                <div class="col-md-6 mt-5 mt-md-0 py-lg-3 ps-md-4" data-aos="fade-right" data-aos-delay="300">
                    ...
                    <ul>
                        <li class="fs-5">We source projects that align with the Sustainable Development Goals (SDGs) set
                            by the United Nations</li>
                        <li class="fs-5">Projects are selected based on your specific investment objectives, including
                            sector, impact, duration, capital amount, and yield targets. Additionally, we manage the
                            preliminary due diligence process to optimize time and resources for all parties.</li>
                    </ul>
                </div>
            </div>
            <div class="row justify-content-center flex-column-reverse flex-md-row align-items-center py-5">
                <div class="col-md-6 py-lg-3 mt-5 mt-md-0 pe-md-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <ul>
                        <li class="fs-5">With offices in Western and Central Africa, Ireti Capital directly contributes
                            to the local economy by collaborating closely with local communities.</li>
                        <li class="fs-5">Ireti Capital is a member of Principles for Responsible Investments (PRI), an
                            organization supported by the United Nations which is the leading proponent of responsible
                            investment around the world.</li>
                        <li class="fs-5">Our annual investment program is designed to assist our NGO and ESG fund
                            partners in securing additional resources to achieve their missions.</li>
                    </ul>
                </div>
                <div class="col-md-6 py-lg-3" data-aos="fade-right" data-aos-delay="300">
                    <img src="{{asset('img/plan.svg')}}" alt="plan" class="w-100">
                </div>
            </div>
            <div class="row align-items-center justify-content-center py-5">
                ...
                <div class="col-md-8  px-sm-5" data-aos="fade-right" data-aos-delay="300">
                    <img src="{{ asset('img/main.svg') }}" alt="ngo" class="w-100">
                </div>
            </div>
        </div>
    </section>
