                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="position" class="form-control mb-3">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="inputPhone" class="form-control mb-3">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <div>
                                    ...
                                    <input type="date" id="regDate" class="form-control mb-3">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="corWeb" class="form-control mb-3">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="emp" class="form-control mb-3">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="accordion-body">
                                <div>
                                    <label for="regCountry" class="form-label fw-bold mb-2">Incorporation
                                        Country</label>
                                    <input type="text" id="regCountry" class="form-control mb-3">
                                </div>
                                <div>
                                    <label for="regAdd" class="form-label fw-bold mb-2">Registered Address</label>
                                    <input type="text" id="regAdd" class="form-control mb-3">
                                </div>
                                <div>
                                    <label for="regCity" class="form-label fw-bold mb-2">Registered City</label>
                                    <input type="text" id="regCity" class="form-control mb-3">
                                </div>
                                <div>
                                ...
                                <div class="d-flex align-items-center mt-4 mb-2">
                                    <input type="checkbox" id="same" class="me-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="opAdd" class="form-control mb-3">
                                </div>
                                <div>
                                    <label for="opacity-hover" class="form-label fw-bold mb-2">Operating City</label>
                                    <input type="text" id="opacity-hover" class="form-control mb-3">
                                </div>
                                <div>
                            ...
                            <div class="accordion-body">
                                ...
                                <div>
                                    <label for="serviceDes" class="form-label fw-bold mb-2">Product/Service
                                        Description</label>
                                    <textarea name="" rows="6" id="serviceDes" class="form-control mb-3"
                                        placeholder="Please describe in detail the product or service you offer, solutions provided by your services or services, and the scope of the product or service, the markets to sell the product and service, as well as the main business partners."></textarea>
                                </div>
                                <div>
                                ...
                                <div>
                                    <label for="otherweb" class="form-label fw-bold mb-2">Please specify, if
                                        other</label>
                                    <textarea name="" rows="6" id="otherweb" class="form-control mb-3" placeholder="Please "></textarea>
                                </div>
                                <div>
                            ...
                            <div class="accordion-body">
                                <div>
                                    ...
                                    <p>Original seen (certified true copy) Valid photo ID of Directors and the UBOs. The
                                        ...
                                        passport.</p>
                                    <input type="file" id="idcard" class="form-control mb-3" multiple>
                                </div>
                                <div>
                    ...
                    <div class="p-3 ps-0 pe-0">
                        ...
                        <div class="row align-items-center mt-3">
                            <div class="col-3 col-md-1 col-sm-2">
                                <div class="">
                                    <input type="radio" class="" id="check1" name="option1"
                                        value="yes" checked>
                            ...
                            <div class="col-3 col-md-1 col-sm-2">
                                <div class="">
                                    <input type="radio" class="" id="check2" name="option1"
                                        value="no">
                            ...
                            <div class="col-md-10 col-sm-8 mt-3 mt-sm-0">
                                <div class="fw-bold d-sm-flex align-items-center">
                                    <label for="specify1" class="mb-0 text-nowrap me-3">If Yes, please
                                        specify:</label>
                                    <input id="specify1" type="text" class="form-control ">
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="row align-items-center mt-3">
                            <div class="col-3 col-md-1 col-sm-2">
                                <div class="">
                                    <input type="radio" class="" id="check3" name="option2"
                                        value="yes" checked>
                            ...
                            <div class="col-3 col-md-1 col-sm-2">
                                <div class="">
                                    <input type="radio" class="" id="check4" name="option2"
                                        value="no">
                            ...
                            <div class="col-md-10 col-sm-8 mt-3 mt-sm-0">
                                <div class="fw-bold d-sm-flex align-items-center">
                                    <label for="specify2" class="mb-0 text-nowrap me-3">If Yes, please
                                        specify:</label>
                                    <input id="specify2" type="text" class="form-control ">
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
