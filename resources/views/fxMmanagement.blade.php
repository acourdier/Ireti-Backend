    ...
    <section class="bg-grey details py-5">
        <div class="mycontainer">
            <div class="row justify-content-center align-items-center py-5">
                <div class="col-12">
                    <h1 class="font-bold text-black  display-4 text-center" data-aos="fade-right" data-aos-delay="300">FX Management Consulting</h1>
                    <p class="text-center mt-3 fs-5" data-aos="fade-up" data-aos-delay="500">At Ireti Capital, we recognize that a considerable number of
        ...
        <div class="mycontainer">
            <div class="row justify-content-center align-items-center py-5">
                ...
                <div class="col-md-6 mt-5 mt-md-0" data-aos="fade-right" data-aos-delay="300">
                    ...
                    <p  class="fs-5">For companies without a dedicated FX management team, exposure to market fluctuations can pose
            ...
            <div class="row justify-content-center flex-column-reverse flex-md-row align-items-center py-5">
                <div class="col-md-6 mt-5 mt-md-0" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p  class="fs-5">We understand the importance of optimizing currency flows to enhance financial performance. Our
            ...
            <div class="row justify-content-center align-items-center py-5">
                ...
                <div class="col-md-6 mt-5 mt-md-0" data-aos="fade-down" data-aos-delay="300">
                    ...
                    <p  class="fs-5">To protect companies margins and rentability, our consultants develop and implement customized
